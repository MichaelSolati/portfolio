const data = {
	...
	"experiences": [
		...
		},
		{
			...
			"current": false,
			"description": "Revamped UI, UX and interface for client-facing retargeting platform as well as maintained other e-Commerce marketing platforms. Implemented modern web development techniques, such as custom elements, into older frameworks and software in order to migrate them into new best practices.",
			"icon": "business",
			"type": "work"
		},
		{
		...
		},
		{
			...
			"end": "2016-12-01T08:00:00.000Z",
			"current": false,
			"description": "Organize weekly meetings and hack nights, support software tutoring sessions for all levels of expertise, and serve as an apprentice within the Apprentice 100 program.",
			"icon": "group",
			"type": "volunteer"
		},
		{
